...
module.exports = {
    ...
    OWN_NUMBER: process.env.OWNER_NUMBER === undefined ? '94741209621' : process.env.OWN_NUMBER,
    OWN_NAME: process.env.OWNER_NAME === undefined ? 'ᴋɪɴɢ ᴀʟᴘʜᴀ' : process.env.OWN_NAME,
    BOT_NAME: process.env.BOT_NAME === undefined ? '[ʙʟᴀᴄᴋ➳ǫᴜᴇᴇɴ] - ᴍᴅ' : process.env.BOT_NAME,
    ST_PKG: process.env.STICKER_PACKAGE === undefined ? '94741209621' : process.env.ST_PKG,
